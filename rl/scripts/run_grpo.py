...
from rl.dataset import load_rl_split_records
from rl.trainer import RLComponents, SpectralGRPOTrainer
...
def main(argv: list[str] | None = None) -> None:
    parser = argparse.ArgumentParser(description="Run lightweight GRPO for the spectral model.")
