...
from data_gen.pipeline.token_vocab import build_token_vocab
from data_gen.scripts.run_build_dataset import resolve_thickness_values_nm
from pso.dataset_writer import write_pso_supplement_dataset
from pso.search import PSOSearchConfig, TMMEvaluationConfig, make_tmm_evaluator, run_pso_search
from pso.targets import TargetProfile, build_default_targets, build_fixed_band_targets, build_lorentzian_targets
...
def main(argv: list[str] | None = None) -> None:
    parser = argparse.ArgumentParser(description="Build a PSO supplement dataset.")
