...
from ga.dataset_writer import write_ga_supplement_dataset
from ga.search import GASearchConfig, TMMEvaluationConfig, make_tmm_evaluator, run_seeded_ga_search
from ga.targets import (
    GATargetProfile,
    build_ga_targets_from_task_specs,
    collect_seed_thickness_values,
    default_ga_task_specs,
)
from ga.visualization import save_ga_spectrum_plots
...
def main(argv: list[str] | None = None) -> None:
    parser = argparse.ArgumentParser(description="Build a seeded genetic-algorithm supplement dataset.")
