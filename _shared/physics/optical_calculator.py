...
try:
    ...
    from _shared.physics.TMM import TMM_solver
...
_DEFAULT_DATABASE_PATH = "_shared/database"
...
def load_material_data(filename, database_path=None):
    ...
    try:
        ...
        if suffix == ".csv":
            ...
            # The flattened workspace stores *.xlsx optical tables as headerless
            # three-column files: wavelength in um, n, k.
